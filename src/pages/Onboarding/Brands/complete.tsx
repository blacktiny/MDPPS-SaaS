...
const BrandsOnboardingCompletePage: React.FC<RouteComponentProps> = () => {
  ...
  return (
    <>
      <QuestionsTemplate steps={STEPS} activeStep={5}>
        <CompleteWrapper>
          <section style={{ maxWidth: boxModel('614px') }}>
            ...
            <Message>
              ...
              <br key="break" />
              <SubscribeLink>Subscribe now</SubscribeLink> or enjoy free access to our platform features for the next 30
              days.
            </Message>
...
export default BrandsOnboardingCompletePage
